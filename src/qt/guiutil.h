...
/** Utility functions used by the prium Qt UI.
 */
namespace GUIUtil
{
...
// Render prium addresses in monospace font
...
// Parse "prium:" URI into recipient object, return true on successful parsing
