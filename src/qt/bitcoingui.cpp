                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("prium Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a prium address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and prium: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About prium Core"), this);
    aboutAction->setStatusTip(tr("Show information about prium Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for prium"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your prium addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified prium addresses"));
    ...
    openAction->setStatusTip(tr("Open a prium: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the prium Core help message to get a list with possible prium command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("prium Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to prium network", "", count));
}
...
{
    QString strTitle = tr("prium Core"); // default title
