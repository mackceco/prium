...
// Copyright (c) 2018 The prium developers
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* prium features */
        {"prium", "masternode", &masternode, true, true, false},
        {"prium", "listmasternodes", &listmasternodes, true, true, false},
        {"prium", "getmasternodecount", &getmasternodecount, true, true, false},
        {"prium", "masternodeconnect", &masternodeconnect, true, true, false},
        {"prium", "masternodecurrent", &masternodecurrent, true, true, false},
        {"prium", "masternodedebug", &masternodedebug, true, true, false},
        {"prium", "startmasternode", &startmasternode, true, true, false},
        {"prium", "createmasternodekey", &createmasternodekey, true, true, false},
        {"prium", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"prium", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"prium", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"prium", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"prium", "getmasternodescores", &getmasternodescores, true, true, false},
        {"prium", "mnbudget", &mnbudget, true, true, false},
        {"prium", "preparebudget", &preparebudget, true, true, false},
        {"prium", "submitbudget", &submitbudget, true, true, false},
        {"prium", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"prium", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"prium", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"prium", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"prium", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"prium", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"prium", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"prium", "checkbudgets", &checkbudgets, true, true, false},
        {"prium", "mnsync", &mnsync, true, true, false},
        {"prium", "spork", &spork, true, true, false},
        {"prium", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"prium", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use priumd, or the -server option to prium-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> prium-cli " + methodname + " " + args + "\n";
}
