...
In order to support loading of multiple wallets in prium-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is prium.cpp.
...
Changes to prium.cpp
----------------------
prium.cpp is the entry point into prium-qt, and as such, will require some minor modifications to provide hooks for
