Contributing to prium Core
============================

The prium Core project operates an open contributor model where anyone is
...
The following applies to code changes to the prium Core project, and is not to be
confused with overall prium Network Protocol consensus changes.

Whether a pull request is merged into prium Core rests with the project merge
...
Patches that change prium consensus rules are considerably more involved than
...
Where a patch set proposes to change the prium consensus, it must have been
...
The project leader is the release manager for each prium Core release.
