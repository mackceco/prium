...
RESOURCES += src/qt/prium.qrc src/qt/prium_locale.qrc

TRANSLATIONS += src/qt/locale/prium_bg.ts \
                src/qt/locale/prium_de.ts \
                src/qt/locale/prium_en.ts \
                src/qt/locale/prium_es.ts \
                src/qt/locale/prium_fi.ts \
                src/qt/locale/prium_fr.ts \
                src/qt/locale/prium_it.ts \
                src/qt/locale/prium_ja.ts \
                src/qt/locale/prium_pl.ts \
                src/qt/locale/prium_pt.ts \
                src/qt/locale/prium_ru.ts \
                src/qt/locale/prium_sk.ts \
                src/qt/locale/prium_sv.ts \
                src/qt/locale/prium_vi.ts \
                src/qt/locale/prium_zh_CN.ts \
                src/qt/locale/prium_zh_TW.ts
